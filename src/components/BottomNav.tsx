  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-50">
      <div className="flex justify-around items-center h-16 max-w-md mx-auto px-4">
        ...
        <Link 
          href="/messages" 
          className={`flex flex-col items-center justify-center p-2 ${pathname.startsWith('/messages') ? 'text-[var(--primary)] dark:text-[var(--primary-light)]' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100'}`}
        >
