...
const BackButton = () => {
  ...
  return (
    <button onClick={() => router.back()} className="inline-flex items-center text-blue-600 hover:underline mb-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-[var(--text-secondary)]">
                  <div>
                    <p><span className="font-medium text-[var(--primary)]">Created:</span> {formatDate(service.createdAt)}</p>
                    <p><span className="font-medium text-[var(--primary)]">Last Updated:</span> {formatDate(service.updatedAt)}</p>
                  </div>
                  {service.walletAddress && (
                    <div>
                      <p className="font-medium text-[var(--primary)]">Seller Wallet:</p>
                      <p className="font-mono text-sm break-all">{service.walletAddress}</p>
                    </div>
                  )}
                </div>
              </div>
